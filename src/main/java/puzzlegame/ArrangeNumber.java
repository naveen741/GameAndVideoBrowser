...
public class ArrangeNumber extends Frame implements ActionListener {
	...
	/**
	 * ArrangeNumber() is constructor used to build and align the frame 
	 * all buttons are labeled and adjusted
	 * actionListener is added to all the buttons
	 */
	ArrangeNumber(){  
	    super("ArrangeNumber");  
	    b1=new Button("1");
	...
	/**
	 * shuffleArea() is used to shuffle the numbers in frame
	 */
	void shuffleArea() {
		for(int i=1;i<9;i++) {
			list.add(""+i);
